...
if(isset($_POST['submit'])){
	...
	$data->read('./excel.xls');
	$title=array('question','type','ans1','ans2','ans3','ans4','ans5','ans6','ans7','ans8','ans9','ans10','ans11','stuMajor');
	$title_str = '';
	...
	$sql_title_str="question,type,ans1,ans2,ans3,ans4,ans5,ans6,ans7,ans8,ans9,ans10,ans11,stuMajor";
	$import_ok = 0;
...
?>
 ...
 <table width="100%" border="1" cellspacing="0" cellpadding="8"  bordercolor="#000000" style="border-collapse:collapse">
   <tr>
     ...
     <td><input type="text" name="sqlName" value="question">
      </td>
   </tr><tr>
